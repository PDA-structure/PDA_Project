...
Last activity: 2026-05-04 -- Completed quick task 260504-ene: Auto-enable chkSupports/chkLoads on mode entry in frame2d setMode(); closes the long-running misdiagnosed "freeze after load" debug session (actual cause = visibility checkbox unchecked, not state-management). Browser UAT passed. truss2d sibling pending. Phase 07 still paused at plan 07-03 Task 2 awaiting Revit access.
